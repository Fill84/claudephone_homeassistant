...
A smart home plugin for [ClaudePhone](https://github.com/Fill84/ClaudePhone) that controls your devices and media players via the Home Assistant REST API.
...
- **Media playback** — play, pause, stop, skip tracks on media players
- **Volume control** — raise or lower volume on media players
...
Once configured, control your smart home and media during a phone call:
